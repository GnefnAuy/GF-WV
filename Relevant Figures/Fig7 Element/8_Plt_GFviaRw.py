...
sns.set_context("poster", font_scale = 9/16 , rc={"grid.linewidth": 9/4})
...
#plt.xticks(T_index)
plt.xlabel('$t$')
plt.ylabel('Re$G_w^{\mathrm{QFT}}$')
plt.savefig('Re_G_L=1.png',dpi=400,bbox_inches ='tight')
plt.show() 
...
#plt.xticks(T_index)
plt.xlabel('$t$')
plt.ylabel('Im$G_w^{\mathrm{QFT}}$')
plt.savefig('Im_G_L=1.png',dpi=400,bbox_inches ='tight')
plt.show() 


#Plt abs
fig3,ax3=plt.subplots( 1, 1, figsize=(4, 2.5), sharey=False, sharex=False)
